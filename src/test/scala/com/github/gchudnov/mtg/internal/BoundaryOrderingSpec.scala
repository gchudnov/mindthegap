  ...
  "BoundaryOrdering" when {
    ...
    "(RightBoundary, LeftBoundary)" should {
      "compare" in {
        ...
        // ord.compare(RightBoundary[Int](Some(2), isInclude = false), LeftBoundary[Int](Some(1), isInclude = true)) mustBe (1)
        ...
        // // -inf, -inf
        // ord.compare(RightBoundary[Int](None, isInclude = true), LeftBoundary[Int](None, isInclude = true)) mustBe (0)
        ...
        // ord.compare(RightBoundary[Int](None, isInclude = false), LeftBoundary[Int](None, isInclude = false)) mustBe (0)
      }
    }    
  }
