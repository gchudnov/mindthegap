...
private[mtg] object MergesIsMergedBy:
  ...
  final def merges[T: Domain](a: Interval[T], b: Interval[T]): Boolean =
    ...
    (a.isEmpty || b.isEmpty) || (
      (ordE.lteq(a.leftEndpoint, b.rightEndpoint) &&
        ordE.lteq(b.leftEndpoint, a.rightEndpoint)) || (ordE.equiv(a.rightEndpoint.succ, b.leftEndpoint) ||
        ordE.equiv(b.rightEndpoint.succ, a.leftEndpoint))
    )
